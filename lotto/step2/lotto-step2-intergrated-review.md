...
- [PR 136](https://github.com/woowacourse/javascript-lotto/pull/136#discussion_r820091000) `Array.from`을 통해 `map`의 작업도 동시에 할 수 있다.
...
- [PR 146](https://github.com/woowacourse/javascript-lotto/pull/146#issuecomment-1060542912) 생성자에서 해줘도 될 일을 굳이 함수로 빼줄 필요는 없다.
...
### react의 jsx를 모티브로 한, 선언적인 요소 생성 방식
...
- [PR 140](https://github.com/woowacourse/javascript-lotto/pull/140#issuecomment-1060418153) 랜덤을 위한 테스트에는 `mock`을 사용해보자.
